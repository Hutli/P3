...
\title[openPlaylist]{P3: openPlaylist}
\subtitle{En Software Analyse og -Implementation}
\date{26/01 2015}
\author[ds318e14] 
{
    Alexander Krog
    ...
    \href{mailto:fhan13@student.aau.dk}{\textit{<fhan13@student.aau.dk>}}\linebreak
