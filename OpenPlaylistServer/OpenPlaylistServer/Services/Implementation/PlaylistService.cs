...
namespace OpenPlaylistServer.Services.Implementation
{
    public class PlaylistService : IPlaylistService
    {
        ...
        public Track FindTrack(string trackUri) { return Tracks.FirstOrDefault(x => x.Uri == trackUri); }
        public ObservableCollection<Track> Tracks { get; private set; }
        public int CalcTScore(Track track) { return _userService.Users.Where(u => u.Vote != null).Count(u => Equals(u.Vote.Track, track)); }
