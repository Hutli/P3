...
namespace OpenPlaylistServer.Services.Implementation
{
    ...
    public partial class MainWindow : IMainWindow
    {
        ...
        private void OnLogInError(LoginState loginState) { Dispatcher.Invoke(() => { LoggedInStatus.Content = "Error: " + loginState; }); }
        //WPF Content
        private void PlayButton_Click(object sender, RoutedEventArgs e) { _viewModel.PlayButtonClicked(); }
        private void StopButton_Click(object sender, RoutedEventArgs e) { _viewModel.StopButtonClicked(); }
        ...
        private void Image_MouseDown(object sender, MouseButtonEventArgs e) { _viewModel.TrackEnded(); }
