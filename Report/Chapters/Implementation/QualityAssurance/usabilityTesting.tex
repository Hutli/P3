...
During this session every problem found in the earlier sessions where discussed. Problems that could where organised into one general problem and all these general problems where put on one list.
