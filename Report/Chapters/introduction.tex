...
\end{enumerate}
This project seeks to eliminate all three of these problems by creating an innovative solution for requesting tracks in a bar context.\kanote{Human errors (bartender kan fx glemme requestet)}

\section{Initial problem}
This project will work with an interactive system at social venues such as bars and pubs with a focus on enabling users to cater their own music preferences.