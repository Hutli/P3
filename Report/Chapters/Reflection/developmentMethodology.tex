In this project it was chosen to follow an iterative development process. This was chosen because the success criteria for this project are not well defined, since the goal of picking which track to play next is a largely subjective decision.
\frnote{citer Computers in Context}
...
\begin{figure}[hbtp]
  ...
  \caption{Overview of the iterative development methodology}\label{fig:subjectRoom}
\end{figure}
