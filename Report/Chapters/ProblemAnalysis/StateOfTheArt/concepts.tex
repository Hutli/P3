...
The article The Interaction Space of a Multi-Device Multi-User Music Experience (ISMDMUME) \cite{sorensen2012} of which this report is inspired from focus heavily on the interaction between users and how to convert multiple devices into one system.
