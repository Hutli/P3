...
\begin{itemize}
    \item The client should be minimalistic, so as to improve understandability and learnability, even for intoxicated users. \chnote{Vi har ikke nævnt noget om alcohol endnu}
