...
It was very important for all bars, that the music does not unexpectedly stop playing. It was expressed that this is due to the atmosphere the music creates. They also expressed that sometimes the venue must be able to purposely pause or stop the music to, for instance, give announcements, close the bar or similar. Furthermore, one bar owner was concerned with streaming music from the internet, because of potential internet failures. A backup solution working offline would be ideal.
...
\item The system should have no disruption in playback, unless desired by the administrator.
\item Ensured continuity in the flow of music.
