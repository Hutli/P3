...
As the people using the system are possibly intoxicated and in contexts where a lot of social activity takes place, the system must be intuitive and efficient in its actions and navigation, as to not interrupt social connections. Therefore the system should focus on providing a small set of functionality that is easy to discover and fast to use.
