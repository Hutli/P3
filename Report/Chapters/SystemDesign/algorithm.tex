...
\caption{Algorithm for finding the next track to be played.}\label{alg:smartfind}
\begin{algorithmic}[1]
	...
	\Function{findRelated}{$trackHistory$} \Comment{$trackHistory$ is a list of previously played tracks.}
