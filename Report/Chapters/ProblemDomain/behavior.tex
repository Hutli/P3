...
\begin{figure}[H]
  \centering
  \includegraphics[width=.5\textwidth]{StateDiagramUser.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=.5\textwidth]{StateDiagramPlaylist.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=.5\textwidth]{StateDiagramTrack.pdf}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=.5\textwidth]{StateDiagramRestriction.pdf}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=.5\textwidth]{pd_venueState.png}
