...
There are different ways of evaluating the usability of a user interface. The two WE will look at in this report are empirically and heuristically testing. The goal of a usability test is to come up with a list of usability problems. A usability problems is \dots \frnote{her mangler lidt}
