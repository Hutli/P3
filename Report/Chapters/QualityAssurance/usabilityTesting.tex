...
\noindent\textbf{Problem \#2 - Confusion about multiple copies of the same song on the playlist
  ...
  playing. An example of this can be seen on \cref{fig:twoSongs}. This would confuse the test persons, and they would get
  unsure about which end of the playlist was ranked highest.\\

\begin{figure}[hbtp]
  \centering
  \includegraphics[width=0.3\linewidth]{twoSongs}
  \caption{Here Chandelier is playing and still at the bottom of the playlist}\label{fig:twoSongs}
\end{figure}
...
\noindent\textbf{Problem \#6 - Did not know in which direction to swipe on the start page. Test
  ...
  swipe in order to get to the check in page. As seen on fig \cref{fig:swipe} this arrow was wrongly
...
\begin{figure}[hbtp]
  ...
  \caption{Screenshot of the search view from the test. The clear search button can be seen in the top right}\label{fig:search}
\end{figure}
