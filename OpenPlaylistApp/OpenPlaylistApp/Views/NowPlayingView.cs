...
namespace OpenPlaylistApp.Views
{
    class NowPlayingView : ContentView
    {
        ...
        private Label _trackArtistLabel = new Label();
        ...
        public NowPlayingView()
        {
            ...
            layout.Children.Add(_trackTitleLabel, Constraint.Constant(0), Constraint.RelativeToParent((parent) => { return parent.Height / 2; }));
            layout.Children.Add(_trackArtistLabel, Constraint.RelativeToParent((parent) => { return parent.Width / 2; }),Constraint.RelativeToParent((parent) => { return parent.Height / 2; }));
        ...
        void OnLoadComplete()
        {
            _trackTitleLabel.Text = npvm.Result.Name;
            _trackArtistLabel.Text = npvm.Result.Album.Artists[0].Name;
            _trackImage.Source = npvm.Result.Album.Images[0].URL;
            progressBar.Progress = Convert.ToDouble(npvm.Result.currentDurationStep) / Convert.ToDouble(npvm.Result.Duration)*10;
